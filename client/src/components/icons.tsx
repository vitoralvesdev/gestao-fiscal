...
export function IconUploadCloud({ size = 28, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" className={className} {...base}>
      <path d="M7 18a4 4 0 0 1-1-7.87A5.5 5.5 0 0 1 16.5 8.5 4.5 4.5 0 0 1 17 18H7z" />
...
export function IconGoogle({ size = 18, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" className={className}>
      <path
        fill="#4285F4"
        d="M23.52 12.27c0-.85-.08-1.67-.22-2.46H12v4.66h6.47a5.54 5.54 0 0 1-2.4 3.63v3h3.89c2.27-2.09 3.58-5.17 3.58-8.83z"
      />
      <path
        fill="#34A853"
      ...
      <path
        fill="#FBBC05"
        d="M5.28 14.31A7.2 7.2 0 0 1 4.9 12c0-.8.14-1.58.38-2.31v-3.1H1.27A12 12 0 0 0 0 12c0 1.94.46 3.77 1.27 5.41z"
      />
      <path
        fill="#EA4335"
...
export function IconLinkOff({ size = 18, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" className={className} {...base}>
...
export function IconListView({ size = 18, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" className={className} {...base}>
...
export function IconTableView({ size = 18, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" className={className} {...base}>
...
export function FileKindIcon({ kind, ...props }: { kind: FileKind } & IconProps) {
  if (kind === 'other') return <IconFile {...props} />;
